...
public class DeliveryAddedItemList extends AppCompatActivity {

    ListView listView;
    List<DeliverAddedItems> user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_added_item_list);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot studentDatasnap : dataSnapshot.getChildren()) {
                    ...
                    DeliverAddedItems deliveryAddedItem = studentDatasnap.getValue(DeliverAddedItems.class);
                    user.add(deliveryAddedItem);

                }

                MyAdapter adapter = new MyAdapter(DeliveryAddedItemList.this, R.layout.custom_product_deliver_deails, (ArrayList<DeliverAddedItems>) user);
    ...
    class MyAdapter extends ArrayAdapter<DeliverAddedItems> {
        LayoutInflater inflater;
        Context myContext;
        List<DeliverAddedItems> user;


        public MyAdapter(Context context, int resource, ArrayList<DeliverAddedItems> objects) {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = inflater.inflate(R.layout.custom_product_deliver_deails, null);
            ...
            holder.button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final EditText editText6 = (EditText) view1.findViewById(R.id.updateUqty);
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (name.equals("")) {
                                ...
                                Toast.makeText(DeliveryAddedItemList.this, "Updated successfully", Toast.LENGTH_SHORT).show();
